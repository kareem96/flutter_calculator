...
import 'package:flutter_calculator/src/utils/colors.dart';
import 'package:flutter_calculator/src/widget/button.dart';
              ...
              itemBuilder: (context, index) {
                switch (index) {
                  ...
                  default:
                    return CustomButton(
                      buttonTapped: () {
                        controller.onButtonTapped(buttons, index);
                      },
                      color: themeController.isDark
                          ? DarkColors.btnBgColor
                          : LightColors.btnBgColor,
