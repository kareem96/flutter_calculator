...
class DarkColors{
  ...
  static const sheetBgColor = Color(0xff22252D);
...
class LightColors{
  ...
  static const sheetBgColor = Color.fromARGB(255, 243, 243, 243);
  static const btnBgColor = Color.fromARGB(255, 243, 243, 243);
  static const operatorColor = Color(0xffEB6666);
  static const leftOperatorColor = Color.fromARGB(255,1,175, 128);
}
